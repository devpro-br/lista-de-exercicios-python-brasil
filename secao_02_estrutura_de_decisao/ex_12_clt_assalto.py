...
def calcular_salario_liquido(valor_hora: float, horas_trabalhadas: int):
    ...
    #Auxilio do print#
    porcentagem_ir = str(porcentagem_ir)
    valor_hora = str('%.2f'%valor_hora)
    ...
    primeira_linha = str('Salário Bruto: (R$ '+valor_hora+' * '+ horas_trabalhadas+')')
    segunda_linha = str('(-) IR ('+porcentagem_ir+'%)')
    terceira_linha = str('(-) INSS ('+'%.0f'%porcentagem_inss+'%)')
    quarta_linha = str('(-) Sindicato ('+'%.0f'%porcentagem_sindicato+'%)')
    quinta_linha = str('FGTS ('+'%.0f'%porcenteagem_fgts+'%)')
    sexta_linha = str('Total de descontos')
    setima_linha = str('Salário Liquido')
    print(primeira_linha.ljust(35,' '),': R$', salario.rjust(9,' '), sep='')
    print(segunda_linha.ljust(35,' '),': R$', ir.rjust(9,' '), sep='')
    print(terceira_linha.ljust(35,' '),': R$', inss.rjust(9,' '), sep='')
    print(quarta_linha.ljust(35,' '),': R$', sindicato.rjust(9,' '), sep='')
    print(quinta_linha.ljust(35,' '),': R$', fgts.rjust(9,' '), sep='')
    print(sexta_linha.ljust(35,' '),': R$',total_descontos.rjust(9,' '), sep='')
    print(setima_linha.ljust(35,' '),': R$', salario_liquido.rjust(9,' '), sep='')