...
def calcular_ano_ultrapassagem_populacional(
    ...
    if taxa_crescimento_populacao_maior < taxa_crescimento_populacao_menor:
        ...
        taxa_a = taxa_crescimento_populacao_menor * 100
        taxa_b = taxa_crescimento_populacao_maior * 100
        print(f"'A taxa de crescimento do país B ({taxa_b}%) deve ser menor do que a do país A ({taxa_a}%)'")
