...
def calcular_area_de_quadrado():
    ...
    lado = float(input("Para o cálculo da área do quadrado, digite um dos lados: "))
    calculo = (lado**2)
    dobro = calculo*2
    print("A área do quadrado com esse lado é:", "%.2f" % calculo)
    print("O dobro da aŕea do quadrado é:", "%.2f" % dobro)
