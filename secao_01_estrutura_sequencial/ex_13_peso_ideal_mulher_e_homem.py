...
def calcular_peso_ideal():
    ...
    pesoi_H = (72.7 * altura) - 58
    pesoi_M = (62.1 * altura) - 44.7

    print(f'Seu peso ideal é {pesoi_M:.1f} kg, se você for mulher')
    print(f'Seu peso ideal é {pesoi_H:.1f} kg, se você for homem')
