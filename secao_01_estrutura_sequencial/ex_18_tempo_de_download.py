...
def calcular_tempo_de_download():
    ...
    tamanho_arquivo = int(input("Entre com o tamanho do arquivo para baixar: "))
    velocidade = int(input("Entre com a velocidade de download do seu link: "))
    tempo = tamanho_arquivo / (velocidade / 8)
    print(f"O tempo aproximado do Download é: {round(tempo / 60)} minuto(s)")
